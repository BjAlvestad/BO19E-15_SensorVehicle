...
namespace SensorVehicle_extras.Configuration
{
    public static class ConfigurationFile
    {
        ...
        //public static object VideoSubtypeHelper { get; private set; }
        ...
        public static async Task Write(VideoSetting videoSetting)
        {
            ...
            var configuration = new JsonObject
                        {
                            { "VideoResolution", JsonValue.CreateNumberValue((int)VideoResolution.SD640_480) },
                            { "VideoSubtype", JsonValue.CreateStringValue("NV12") },
                            { "VideoQuality", JsonValue.CreateNumberValue(0.2) },
                            { "UsedThreads", JsonValue.CreateNumberValue(1) }
                        };

            VideoSetting = configuration;

            await FileIO.WriteTextAsync(configurationFile, configuration.Stringify()); //Here
        }
