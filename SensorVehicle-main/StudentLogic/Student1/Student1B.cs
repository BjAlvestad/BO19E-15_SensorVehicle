...
{
    public class Student1B : StudentLogicBase
    {
        public override StudentLogicDescription Details { get; }

        public Student1B(IWheel wheel, IEncoders encoders, ILidarDistance lidar, IUltrasonic ultrasonic) : base(wheel)
        {
            Details = new StudentLogicDescription
            {
                Title = "Empty logic for Student 1 (B)",
                Author = "Student 1",
