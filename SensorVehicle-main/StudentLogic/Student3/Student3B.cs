...
namespace StudentLogic.Student3
{
    public class Student3B : StudentLogicBase
    {
        public override StudentLogicDescription Details { get; }

        public Student3B(IWheel wheel, IEncoders encoders, ILidarDistance lidar, IUltrasonic ultrasonic) : base(wheel)
        {
            Details = new StudentLogicDescription
            {
                Title = "Empty logic for Student 3 (B)",
                Author = "Student 3",
                Description = "This program is empty.\n" +
                              ...
                              "All this is done in the Student3B.cs file."
            };
